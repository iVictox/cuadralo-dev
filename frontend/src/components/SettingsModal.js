...
import { X, Lock, Trash2, Loader2, LogOut, Palette, Moon, Sun, CheckCircle, Settings, ShieldCheck, ShieldAlert, RefreshCw } from "lucide-react";
...
export default function SettingsModal({ onClose }) {
  ...
  const handleChangePassword = async (e) => {
    e.preventDefault();
    if (user?.google_id) return showToast("Tu cuenta está vinculada a Google. No es posible cambiar la contraseña.", "error");
            ...
            >
              ...
              {activeTab === "security" && (
                  <div className="space-y-8">
                      ...
                      {user?.google_id ? (
                          <div className="bg-gradient-to-br from-gray-500/10 to-gray-400/5 border border-gray-500/20 rounded-[2rem] p-8 md:p-10 text-center relative overflow-hidden">
                              <div className="absolute top-0 right-0 w-32 h-32 bg-gray-500/20 rounded-full blur-[50px]"></div>
                              
                              <div className="w-24 h-24 bg-gray-500/20 rounded-full flex items-center justify-center mx-auto text-gray-500 mb-6 relative z-10">
                              ...
                              <h4 className="text-xl font-black text-cuadralo-textLight dark:text-white mb-2 relative z-10">Cuenta vinculada a Google</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium leading-relaxed relative z-10">
                                  Has iniciado sesión con <b>Google</b>. No es necesario configurar una contraseña para esta cuenta.
                              </p>
                          </div>
                      ) : (
              ...
              {activeTab === "verification" && (
                  <div className="space-y-8">
                      ...
                      {user?.is_verified ? (
                          <div className="bg-gradient-to-br from-green-500/10 to-blue-500/5 border border-green-500/20 rounded-[2rem] p-8 md:p-10 text-center relative overflow-hidden">
                              <div className="absolute top-0 right-0 w-32 h-32 bg-green-500/20 rounded-full blur-[50px]"></div>

                              <div className="w-24 h-24 bg-green-500/20 rounded-full flex items-center justify-center mx-auto text-green-500 mb-6 relative z-10 shadow-[0_0_30px_rgba(34,197,94,0.3)]">
                                  <ShieldCheck size={48} className="drop-shadow-md"/>
                              </div>

                              <h4 className="text-xl font-black text-green-500 mb-2 relative z-10">¡Cuenta Verificada!</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium leading-relaxed mb-4 relative z-10">
                                  Tu identidad ha sido confirmada exitosamente. Tienes la insignia azul en tu perfil.
                              </p>
                              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 mb-6 relative z-10">
                                  <p className="text-xs text-yellow-600 dark:text-yellow-400 font-medium">
                                      ⚠️ Si cambias tu foto de perfil, perderás la verificación y deberás volver a verificarte.
                                  </p>
                              </div>
                          </div>
                      ) : (
                          <div className="bg-gradient-to-br from-blue-600/10 to-blue-400/5 border border-blue-500/20 rounded-[2rem] p-8 md:p-10 text-center relative overflow-hidden">
                              ...
                              <div className="w-24 h-24 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto text-blue-500 mb-6 relative z-10 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
                                  <ShieldAlert size={48} className="drop-shadow-md"/>
                              </div>
